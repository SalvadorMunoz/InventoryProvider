package com.example.usuario.inventoryprovider.data.db;
...
public final class InventoryContract {
    ...
    public static class ProductInnerEntry implements BaseColumns {
        ...
        public static final String[] ALL_COLUMNS = new String[] {
                ...
                COLUMN_SUBCATEGORY,COLUMN_SUBCATEGORYNAME, COLUMN_PRODUCTCLASS,COLUMN_PRODUCTCLASSDESCRIPTION, COLUMN_SECTOR,COLUMN_SECTORNAME, COLUMN_QUANTITY, COLUMN_VALUE, COLUMN_VENDOR,
                COLUMN_BITMAP, COLUMN_IMAGENAME, COLUMN_URL, COLUMN_DATEPURCHASE, COLUMN_NOTES
        };
        ...
        public static final String PRODUCT_INNER=String.format("%s INNER JOIN %s ON %s=%s.%s " +
                ...
                "INNER JOIN %s ON %s=%s.%s " +
                "INNER JOIN %s ON %s=%s.%s ", TABLE_NAME,
                CategoryEntry.TABLE_NAME,COLUMN_CATEGORY, CategoryEntry.TABLE_NAME, CategoryEntry._ID,
                SubcategoryEntry.TABLE_NAME, COLUMN_SUBCATEGORY,SubcategoryEntry.TABLE_NAME, SubcategoryEntry._ID,
                ProductClassEntry.TABLE_NAME, COLUMN_PRODUCTCLASS,ProductClassEntry.TABLE_NAME, ProductClassEntry._ID,
                SectorEntry.TABLE_NAME, COLUMN_SECTOR,SectorEntry.TABLE_NAME, SectorEntry._ID
                );

        public static HashMap<String,String> sProductInnerProjectMap;
        static {
            sProductInnerProjectMap = new HashMap<>();
            sProductInnerProjectMap.put(ProductEntry._ID,ProductEntry.TABLE_NAME+"."+ProductEntry._ID);
            sProductInnerProjectMap.put(COLUMN_SERIAL, COLUMN_SERIAL);
            sProductInnerProjectMap.put(COLUMN_MODELCODE, COLUMN_MODELCODE);
            sProductInnerProjectMap.put(COLUMN_SORTNAME, ProductInnerEntry.TABLE_NAME + "." + ProductInnerEntry.COLUMN_SORTNAME);
            sProductInnerProjectMap.put(COLUMN_DESCRIPTION, ProductInnerEntry.TABLE_NAME + "." + ProductInnerEntry.COLUMN_DESCRIPTION);
            sProductInnerProjectMap.put(COLUMN_CATEGORY, CategoryEntry.TABLE_NAME + "." + CategoryEntry._ID);
            sProductInnerProjectMap.put(COLUMN_CATEGORYNAME, CategoryEntry.TABLE_NAME + "." + CategoryEntry.COLUMN_NAME);
            sProductInnerProjectMap.put(COLUMN_SUBCATEGORY, SubcategoryEntry.TABLE_NAME + "." + SubcategoryEntry._ID);
            sProductInnerProjectMap.put(COLUMN_SUBCATEGORYNAME, SubcategoryEntry.TABLE_NAME + "." + SubcategoryEntry.COLUMN_NAME);
            sProductInnerProjectMap.put(COLUMN_PRODUCTCLASS, ProductClassEntry.TABLE_NAME + "." + ProductClassEntry._ID);
            sProductInnerProjectMap.put(COLUMN_PRODUCTCLASSDESCRIPTION, ProductClassEntry.TABLE_NAME + "." + ProductClassEntry.COLUMN_DESCRIPTION);
            sProductInnerProjectMap.put(COLUMN_SECTOR, SectorEntry.TABLE_NAME + "." + SectorEntry._ID);
            sProductInnerProjectMap.put(COLUMN_SECTORNAME, SectorEntry.TABLE_NAME + "." + SectorEntry.COLUMN_NAME);
            sProductInnerProjectMap.put(COLUMN_QUANTITY, COLUMN_QUANTITY);
            sProductInnerProjectMap.put(COLUMN_VALUE, COLUMN_VALUE);
            sProductInnerProjectMap.put(COLUMN_VENDOR, COLUMN_VENDOR);
            sProductInnerProjectMap.put(COLUMN_BITMAP, COLUMN_BITMAP);
            sProductInnerProjectMap.put(COLUMN_IMAGENAME, COLUMN_IMAGENAME);
            sProductInnerProjectMap.put(COLUMN_URL, COLUMN_URL);
            sProductInnerProjectMap.put(COLUMN_DATEPURCHASE, COLUMN_DATEPURCHASE);
            sProductInnerProjectMap.put(COLUMN_NOTES, COLUMN_NOTES);
